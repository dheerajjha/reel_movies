...
<?php
	...
	{
			$sql3="Update `course_exit_responses` set a4='$response' where s_id=$s_id and c_id=$c_id";
	$sql4="Update `course_exit_responses` set a4_exp='$m1' where s_id=$s_id and c_id=$c_id";
	...
	else
	{
		...
		$sql5="INSERT INTO `course_exit_responses`(`s_id`,`c_id`, `a4`, `a4_exp`) VALUES ('$s_id','$c_id','$response','$m1')";
